<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="CrearFicha.aspx.cs" Inherits="ProyectoSena.Vista.Administrador.CrudFichas.CrearFicha" %>
    ...
    <main class="p-4">
        ...
        <nav class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Nueva Ficha </li>
            </ol>
        </nav>
        <!-- HEADER -->
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="fw-bold">Crear Nueva Ficha </h2>
                <p class="text-muted">Registre la información básica para una nueva ficha educativa. </p>
            </div>
            ...
            <form>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtCodigoFicha" class="form-control form-control-lg" runat="server" placeholder="Ej: 123456"></asp:TextBox>
                    </div>
                    <!-- VERSION -->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="txtDescripcion" class="form-control form-control-lg" placeholder="Escriba una descripcion" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-4 mt-4">
                    <div class="col-md-6">
                        <div class="info-box bg-primary bg-opacity-10">
                            ...
                            <p class="mb-0 text-muted">El sistema validará automáticamente el código de la ficha. </p>
                        </div>
                    </div>
                    <div class="col-md-6">
