<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="CrearInstructor.aspx.cs" Inherits="ProyectoSena.Vista.Administrador.CrudInstructores.CrearInstructor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <main class="p-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="fw-bold">Crear Nuevo Instructor </h2>
                <p class="text-muted">Registre la información básica para un nuevo instructor. </p>
            </div>
