<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="CrearPrograma.aspx.cs" Inherits="ProyectoSena.Vista.CrudProgramas.CrearPrograma" %>
    ...
    <main class="p-4">
        ...
        <nav class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Nuevo Programa </li>
            </ol>
        </nav>
        <!-- HEADER -->
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="fw-bold">Crear Nuevo Programa </h2>
                <p class="text-muted">Registre la información básica para un nuevo programa educativo. </p>
            </div>
            <div class="d-flex gap-3">
                <button class="btn btn-outline-secondary px-4" href="Programas.aspx">Cancelar </button>
                <asp:Button ID="btnGuargarPrograma" class="btn btn-green px-4" runat="server" Text="Guardar Programa" OnClick="btnGuargarPrograma_Click" />
            </div>
        </div>
        <!-- FORM CARD -->
        <div class="form-card">
