<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="CrearAprendiz.aspx.cs" Inherits="ProyectoSena.Vista.Administrador.CrudAprendices.CrearAprendiz" %>
    ...
    <main class="p-4">
        ...
        <nav class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Nuevo Aprendiz </li>
            </ol>
        </nav>
        <!-- HEADER -->
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="fw-bold">Crear Nuevo Aprendiz </h2>
                <p class="text-muted">Registre la información básica para un nuevo Aprendiz. </p>
            </div>
            ...
            <form>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="txtContraseña" class="form-control form-control-lg" placeholder="********" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-6">
