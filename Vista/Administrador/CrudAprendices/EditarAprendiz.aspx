<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Estructura.Master" AutoEventWireup="true" CodeBehind="EditarAprendiz.aspx.cs" Inherits="ProyectoSena.Vista.Administrador.CrudAprendices.EditarAprendiz" %>
    ...
    <main class="p-4">
        ...
        <nav class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Aprendices </a></li>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="fw-bold">Editar Aprendiz </h2>
                <p class="text-muted">Registre la información básica para editar un aprendiz. </p>
            </div>
            <div class="d-flex gap-3">
                <button class="btn btn-outline-secondary px-4" href="Aprendices.aspx">Cancelar </button>
                <asp:Button ID="btnGuardarAprendiz" class="btn btn-green px-4" runat="server" Text="Guardar Aprendiz" OnClick="btnGuardarAprendiz_Click" />
            </div>
        </div>
        <!-- FORM CARD -->
        <div class="form-card">
            <form>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="txtCorreo" class="form-control form-control-lg" placeholder="aprendiz@soy.sena.edu.co" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:DropDownList ID="ddlEstado" class="form-control form-control-lg" runat="server">
                            <asp:ListItem>Seleccione el Estado</asp:ListItem>
                            <asp:ListItem>En Formación</asp:ListItem>
                            <asp:ListItem>Aplazado</asp:ListItem>
                            <asp:ListItem>Desertado</asp:ListItem>
                            <asp:ListItem>Retiro Voluntario</asp:ListItem>
                            <asp:ListItem>Condicionado</asp:ListItem>
